...
class BillDetailTableViewController: UITableViewController, UITextFieldDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if remindSwitch.isOn {
            ...
            bill.scheduleReminder(date: remindDatePicker.date) { updatedBill in
    ...
    func presentNeedAuthorizationAlert() {
        let alert = UIAlertController(title: "Authorization Needed", message: "The app cannot function properly without permission to send notifications", preferredStyle: .alert)
